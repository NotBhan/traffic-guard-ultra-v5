...
# RTSP stream URL
RTSP_URL = "rtsp://admin:admin@10.202.189.73:1935"

# Set the RTSP stream as the source for all directions
SOURCES = {
    direction: {"type": "video", "value": RTSP_URL}
    for direction in DIRECTIONS
}

print(f"[CAM] Using RTSP stream for all directions: {RTSP_URL}")


# Fallback video if something fails (not used when RTSP is hardcoded)
